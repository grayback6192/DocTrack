...
class User extends Controller
{
    ...
    foreach ($documentname as $key) {
        ...
        return view('user/sentDocs',['documentname'=>$documentname,'User'=>$user,'upgid'=>$upgid, 'getarchivearray'=>$getarchivearray]);
    ...
    public function complete($upgid){
        ...
        return view('user/completedocs',['completedoc'=>$view, 'User'=>$user, 'upgid'=>$upgid]);
