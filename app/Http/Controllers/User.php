...
class User extends Controller
{
    ...
    ->download('temp/'.$docid.'.pdf');
        ...
        $samesteptranscount = DB::table('transaction')->where('document_doc_id','=',$docid)
         ...
         $samesteptranscountapproved = DB::table('transaction')->where('document_doc_id','=',$docid)
                                                      ->where('order','=',$currentsteporder)
   ...
   //order status 
    ...
    return view("user/archive",["name"=>$name],["statuss"=>$statuss,'User'=>$user,"pdf"=>$pdf,'docinfos'=>$docInfo,'upgid'=>$upgid,'lastOrder'=>$last_order,'inboxstatus'=>$inboxstatus,'numUnread'=>$numunread,'numinprogress'=>$numinprogress,'docwf'=>$docwf,'comments'=>$comments]);
   ...
   //order status 
    ...
    return view("user/fileStatus",["name"=>$name],["statuss"=>$statuss,'User'=>$user,"pdf"=>$pdf,'docinfos'=>$docInfo,'upgid'=>$upgid,'lastOrder'=>$last_order,'inboxstatus'=>$inboxstatus,'numUnread'=>$numunread,'numinprogress'=>$numinprogress,'docwf'=>$docwf,'comments'=>$comments]);
}
