...
class DocumentController extends Controller
{
   public function readFile($upgid,$gid,$tempid)
    ...
    $comments = \DB::table('comment as c')->where('c.comment_doc_id','=',$id)
       ...
       return view("user/viewDocs",["pdf"=>$pdf, 'User'=>$user, 'status'=>$status, 'time'=>$time, 'date'=>$date, 'docInfos'=>$docInfo,'upgid'=>$upgid,'id'=>$id,'docworkflows'=>$docworkflows, 'comments'=>$comments]);
        //return $id;
