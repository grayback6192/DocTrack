		                ...
		                <!--        You can switch " data-color="orange" "  with one of the next bright colors: "blue", "green", "orange", "red", "azure"          -->
		                	{{csrf_field()}}
		                    	<div class="wizard-header text-center">
		                        	<h3 class="wizard-title">Client Register</h3>
		                            	...
		                            	<div class="row">
											...
											<div class="col-sm-4 col-sm-offset-1">
												<div class="picture-container">
													<div class="picture">
														<input type="file" name="clientprofpic" id="wizard-picture">
...
<label class="radio-inline">
       <input type="radio" name="gender" id="optionsRadiosInline2" value="Female">Female
		                            ...
		                            <div class="tab-pane" id="account">
		                                <h5 class="info-text">Register School</h5>
		                                <div class="row">
		                                      ...
		                                      <div class="col-sm-7 col-sm-offset-1">
		                                    	<div class="form-group">
		                                            ...
		                                            <small>(Unique Access)</small>
		                                            <input type="text" name = "businessKey" class="form-control" placeholder="Business Key">
		                                        </div>
		                                    </div>
