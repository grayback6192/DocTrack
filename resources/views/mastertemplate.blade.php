...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="{{URL::asset('public/img/logos.png')}}">
  <link rel="icon" type="image/png" href="{{URL::asset('public/img/logos.png')}}">
      ...
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright float-right">
            ...
            <a href="" target="_blank">Dexter Solar</a>.
          </div>
          <!-- your footer here -->
        </div>
      </footer>
