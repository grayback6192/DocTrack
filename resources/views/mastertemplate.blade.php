...
{{--     <link rel='stylesheet' type='text/css' href="{{ URL::asset('css/orgchart/css/font-awesome.css') }}">
    <link rel='stylesheet' type='text/css' href="{{ URL::asset('css/orgchart/css/font-awesome.min.css') }}"> --}}
    ...
    {{--Custom --}}
    <link rel='stylesheet' type='text/css' href="{{ URL::asset('css/doctrackcustom.css') }}">
</head>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                               <a href="#" class="dropdown-toggle" type="button" id="notiflist" data-toggle="dropdown">
                                    <i class="material-icons">notifications</i>
                                     @yield('notifNumber')
                                     {{-- <span class="notification">5</span> --}}
                                     <p class="hidden-lg hidden-md">Notifications</p>
                                </a>
                                <ul class="dropdown-menu" aria-labelledby="notiflist">
                                    @yield('notifList')
                                   {{--  <li>
