    ...
    $(window).load(function () {
      var options = new primitives.famdiagram.Config();
       ...
       var items = [
                   ...
                   @if ($file[0]['depPos'] == !'')
                      { id: '{{$file[0]['groupid']}}', email: "{{$file[0]['depName']}}", templateName: "contactTemplate",
      ...
      options.onButtonClick = function (e, data) {
       ...
       function getContactTemplate2() {
        ...
        var itemTemplate = jQuery(
          ...
          + '<div name="titleBackground" class="bp-item bp-corner-all bp-title-frame-custom" style="top: 2px; left: 2px; width: 216px; height: 20px;">'
      ...
      function getContactTemplate() {
        ...
        var itemTemplate = jQuery(
          ...
          + '<center><div name="email" class="bp-item" style="top: 55px; left: 15px; width: 150px; height: 150px; font-size: 17px;"></div></center>'
...
<div style="width: 1400px; height: 1100px; border-style: dotted; border-color: white; background-color: #dcd0c0;">
   <center><h2 style="color: black">Department's Organizational Chart</h2></center>
...
<br>
        <a class="btn btn-info" style="float: right;" href="{{route('showDep',['upgid'=>$upgid,'id'=>$groupid])}}">Back</a>
@endsection
