...
<div class="form-group">
 ...
 <div class="form-group">
   Who can view this template?
   <div class="radio-inline">
    <label>
     <input type="radio" name="viewtemp" id="all" value="All" checked> 
     All
    </label>
   </div>
    <div class="radio-inline">
    <label>
     <input type="radio" name="viewtemp" id="employee" value="Employee"> 
     Employees
    </label>
   </div>
    <div class="radio-inline">
    <label>
     <input type="radio" name="viewtemp" id="student" value="Student"> 
     Students
     </label>
   </div>
