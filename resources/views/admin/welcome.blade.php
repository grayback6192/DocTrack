...
<input type="text" placeholder="selectedNodeUpg" id="selectednodeupg">
 <span id="node-type-panel" class="radio-panel">
      <input type="radio" name="node-type" id="rd-parent" value="parent" checked="checked"><label for="rd-parent">Parent(root)</label>
...
<div class="modal" id="exampleModal">
  ...
  <input type="hidden" placeholder="orgchartid" id="orgchartID" value="{{$orgchartid}}">
...
<input type="hidden" placeholder="edit_name" id="edit_name">
 <input type="hidden" placeholder="edit_upg_id" id="edit_upg_id">
   ...
   <script type="text/javascript">
    ...
    function openNode(){
      var nodemodal = document.getElementById('detailnode');
  ...
  <script type="text/javascript">
    ...
    var oc = $('#chart-container').orgchart({
     ...
     oc.$chartContainer.on('click', '.node', function() {
      ...
      $('#selectednodeupg').val($this.find('input').val()).data('node',$this);
      console.log($('#selectednodeupg').val());
    });
    ...
    $('#btn-add-nodes').on('click', function() {
      ...
      if (nodeType.val() === 'parent') {
        if (!$chartContainer.children('.orgchart').length) {// if the original chart has been deleted
          ...
          var upgid =$('#upg').val();
          oc.addParent($chartContainer.find('.node:first'), { 'name': nodeVals[0], 'Id': getId(),'upgid': upgid, 'positions': positions });
        }
