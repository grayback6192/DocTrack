  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      <div class="row justify-content-between"> 
        <h1 style="margin-left: 20px" class="col-5">{{$depinfo->groupName}}</h1>
...
{{--                             <td>
      ...
      <div class="m-3">
       ...
       {{--    <div class="col-md-offset-2">
        ...
        {{-- @endif --}}
        <a class="btn btn-info" style="float: right; margin-left: 5px;"  href="{{route('vieworgchart',['upgid'=>$upgid,'groupid' => $depid])}}">View Organizational Chart</a>
         <a class="btn btn-info" style="float: right;" href="{{route('vieworgchartdep',['upgid'=>$upgid,'groupid' => $depid])}}">View Department Organization</a>
      </div>
