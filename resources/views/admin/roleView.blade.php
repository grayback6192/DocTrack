...
<div class="col-lg-9" role="group" aria-label="First Group">
	...
	<div class="form-group btn-toolbar">
		<input type="text" class="form-control col-sm-2 btn-group" data-toggle="tooltip" title="Add New Position"  name="newrole" id="newroleid" placeholder="Position Name"> 
		<button type="submit" class="btn-group btn btn-primary" name="addRole"><i class="material-icons md-24">add</i></button>
	</div>
	</form> 
	...
	<tr id="{{$role->pos_id}}-row">
		...
		<td>
			<div id="{{$role->pos_id}}-descfield">	
				...
				{{-- <div id="{{$role->pos_id}}-desc">{{$role->posDescription}}</div> --}}
				{{-- <textarea class="form-control" name="descriptions" rows="2" id="{{$role->pos_id}}-descedit">
					roledescdgfdgjjkl
				</textarea> --}}
			</div>
		</td>
