...
<div class="col-lg-9" role="group" aria-label="First Group">
	<button type="button" class="btn btn-primary" onclick="showAddPosModal()">Add Position Title</button>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="btn-toolbar">
							<div class="btn-group">
								<a href="{{route('DelPos',['upgid'=>$upgid,'roleid'=>$role->pos_id])}}" class="btn btn-primary">YES</a>
							</div>
							<div class="btn-group">
