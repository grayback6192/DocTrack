...
<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
 ...
 <li class="nav-item active" data-toggle="tooltip" data-placement="right" title="Components">
              <a class="nav-link" style="color: black;" data-toggle="collapse" href="{{'showDep',['upgid'=>$upgid,'id'=>Session::get('groupid')]}}" data-placement="right" title="Inbox">
...
<input type="text" name="depname" placeholder="Department Name" class="form-control" />
</div>
  <div class="form-group row">
  <label class="col-sm-4 col-form-label">Description</label>
  <textarea class="form-control" name="depDesc" placeholder="Description"></textarea>
</div>
  <hr>
  <fieldset>
  ...
  <input type="password" id="key" name="depKey" class="form-control" placeholder="Department Key">
...
function showSub()
{
  ...
  <div class="input-group">
    <input type="submit" name="save" value="Add Group" class="btn btn-primary">
  </div>
</div> 
</form>
</div>
